...
export default function ProjectDetailsTile() {
	return (
		<div className="group w-full h-full relative overflow-hidden rounded-4xl bg-gradient-to-b from-white to-[#eef7f4] dark:from-[#0d1117] dark:to-[#0d1117] dark:ring-2 dark:ring-gray-700">
			...
			{/* 手机主体 */}
			<div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-6 transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-[54%] group-hover:-rotate-3">
				<div className="w-[196px] h-[400px] rounded-[2.6rem] bg-white dark:bg-[#161d2b] p-[7px] shadow-[0_36px_70px_-18px_rgba(2,8,23,0.4)] ring-1 ring-black/10 dark:ring-white/10">
			...
			{/* 悬浮玻璃徽章 */}
			<div className="absolute top-7 right-4 z-20 flex items-center gap-1.5 rounded-full bg-white/75 dark:bg-white/10 backdrop-blur-md px-3 py-1.5 text-[11px] font-semibold text-slate-700 dark:text-slate-200 ring-1 ring-black/5 dark:ring-white/15 shadow-[0_10px_24px_-8px_rgba(2,8,23,0.3)] transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-1.5">
				<FiZap className="h-3.5 w-3.5 text-violet-500 dark:text-violet-300" aria-hidden />
				Bento UI
			</div>
			<div className="absolute bottom-16 left-4 z-20 flex items-center gap-1.5 rounded-full bg-white/75 dark:bg-white/10 backdrop-blur-md px-3 py-1.5 text-[11px] font-semibold text-slate-700 dark:text-slate-200 ring-1 ring-black/5 dark:ring-white/15 shadow-[0_10px_24px_-8px_rgba(2,8,23,0.3)] transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-1 delay-75">
